...
public class GestioncomptebancaireApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Operation op1 = operationRepository.save(new Versement(new Date(), 4000, cp1));
        Operation op2 = operationRepository.save(new Versement(new Date(), 2300, cp1));
        Operation op3 = operationRepository.save(new Versement(new Date(), 7100, cp2));
        Operation op4 = operationRepository.save(new Versement(new Date(), 2500, cp2));

        Operation op5 = operationRepository.save(new Retrait(new Date(), 1400, cp1));
        Operation op6 = operationRepository.save(new Retrait(new Date(), 200, cp1));
        Operation op7 = operationRepository.save(new Retrait(new Date(), 100, cp2));
